; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\heap-tests\heap-binarytree-context.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\heap-tests\\heap-binarytree-context.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local %struct.TreeNode* @UseTree(%struct.TreeNode* noundef %0) #0 !dbg !135 {
  %2 = alloca %struct.TreeNode*, align 8
  store %struct.TreeNode* %0, %struct.TreeNode** %2, align 8
  call void @llvm.dbg.declare(metadata %struct.TreeNode** %2, metadata !138, metadata !DIExpression()), !dbg !139
  %3 = load %struct.TreeNode*, %struct.TreeNode** %2, align 8, !dbg !140
  ret %struct.TreeNode* %3, !dbg !141
}
...
define dso_local i32 @main() #0 !dbg !142 {
  ...
  call void @llvm.dbg.declare(metadata %struct.TreeNode** %2, metadata !146, metadata !DIExpression()), !dbg !147
  call void @llvm.dbg.declare(metadata %struct.TreeNode** %3, metadata !148, metadata !DIExpression()), !dbg !149
  call void @llvm.dbg.declare(metadata %struct.TreeNode** %4, metadata !150, metadata !DIExpression()), !dbg !151
  call void @llvm.dbg.declare(metadata %struct.TreeNode** %5, metadata !152, metadata !DIExpression()), !dbg !153
  call void @llvm.dbg.declare(metadata %struct.TreeNode** %6, metadata !154, metadata !DIExpression()), !dbg !155
  %7 = call %struct.TreeNode* @CreateTree1(), !dbg !156
  store %struct.TreeNode* %7, %struct.TreeNode** %2, align 8, !dbg !157
  %8 = call %struct.TreeNode* @CreateTree2(), !dbg !158
  store %struct.TreeNode* %8, %struct.TreeNode** %3, align 8, !dbg !159
  %9 = load %struct.TreeNode*, %struct.TreeNode** %2, align 8, !dbg !160
  %10 = call %struct.TreeNode* @UseTree(%struct.TreeNode* noundef %9), !dbg !161
  store %struct.TreeNode* %10, %struct.TreeNode** %4, align 8, !dbg !162
  %11 = load %struct.TreeNode*, %struct.TreeNode** %3, align 8, !dbg !163
  %12 = call %struct.TreeNode* @UseTree(%struct.TreeNode* noundef %11), !dbg !164
  store %struct.TreeNode* %12, %struct.TreeNode** %5, align 8, !dbg !165
  %13 = load %struct.TreeNode*, %struct.TreeNode** %4, align 8, !dbg !166
  %14 = getelementptr inbounds %struct.TreeNode, %struct.TreeNode* %13, i32 0, i32 1, !dbg !167
  %15 = load %struct.TreeNode*, %struct.TreeNode** %14, align 8, !dbg !167
  %16 = getelementptr inbounds %struct.TreeNode, %struct.TreeNode* %15, i32 0, i32 1, !dbg !168
  %17 = load %struct.TreeNode*, %struct.TreeNode** %16, align 8, !dbg !168
  store %struct.TreeNode* %17, %struct.TreeNode** %6, align 8, !dbg !169
  %18 = load %struct.TreeNode*, %struct.TreeNode** %5, align 8, !dbg !170
  %19 = getelementptr inbounds %struct.TreeNode, %struct.TreeNode* %18, i32 0, i32 2, !dbg !171
  %20 = load %struct.TreeNode*, %struct.TreeNode** %19, align 8, !dbg !171
  %21 = getelementptr inbounds %struct.TreeNode, %struct.TreeNode* %20, i32 0, i32 2, !dbg !172
  %22 = load %struct.TreeNode*, %struct.TreeNode** %21, align 8, !dbg !172
  store %struct.TreeNode* %22, %struct.TreeNode** %6, align 8, !dbg !173
  %23 = load %struct.TreeNode*, %struct.TreeNode** %2, align 8, !dbg !174
  call void @FreeTree(%struct.TreeNode* noundef %23), !dbg !175
  %24 = load %struct.TreeNode*, %struct.TreeNode** %3, align 8, !dbg !176
  call void @FreeTree(%struct.TreeNode* noundef %24), !dbg !177
  ret i32 0, !dbg !178
}
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\heap-tests/heap-binarytree-context.c", directory: "D:/Projects/Python/PointerAnalysis")
!2 = !{!3, !4}
!3 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 64)
!4 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5, size: 64)
!5 = !DIDerivedType(tag: DW_TAG_typedef, name: "TreeNode", file: !6, line: 10, baseType: !7)
!6 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/heap-tests/heap-binarytree-context.c", directory: "")
...
!135 = distinct !DISubprogram(name: "UseTree", scope: !6, file: !6, line: 59, type: !136, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !24)
!136 = !DISubroutineType(types: !137)
!137 = !{!4, !4}
!138 = !DILocalVariable(name: "root", arg: 1, scope: !135, file: !6, line: 59, type: !4)
!139 = !DILocation(line: 59, column: 29, scope: !135)
!140 = !DILocation(line: 61, column: 9, scope: !135)
!141 = !DILocation(line: 61, column: 2, scope: !135)
!142 = distinct !DISubprogram(name: "main", scope: !6, file: !6, line: 64, type: !143, scopeLine: 65, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !24)
!143 = !DISubroutineType(types: !144)
!144 = !{!145}
!145 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!146 = !DILocalVariable(name: "x", scope: !142, file: !6, line: 66, type: !4)
!147 = !DILocation(line: 66, column: 12, scope: !142)
!148 = !DILocalVariable(name: "y", scope: !142, file: !6, line: 66, type: !4)
!149 = !DILocation(line: 66, column: 16, scope: !142)
!150 = !DILocalVariable(name: "r1", scope: !142, file: !6, line: 67, type: !4)
!151 = !DILocation(line: 67, column: 12, scope: !142)
!152 = !DILocalVariable(name: "r2", scope: !142, file: !6, line: 67, type: !4)
!153 = !DILocation(line: 67, column: 17, scope: !142)
!154 = !DILocalVariable(name: "p", scope: !142, file: !6, line: 68, type: !4)
!155 = !DILocation(line: 68, column: 12, scope: !142)
!156 = !DILocation(line: 70, column: 6, scope: !142)
!157 = !DILocation(line: 70, column: 4, scope: !142)
!158 = !DILocation(line: 71, column: 6, scope: !142)
!159 = !DILocation(line: 71, column: 4, scope: !142)
!160 = !DILocation(line: 73, column: 15, scope: !142)
!161 = !DILocation(line: 73, column: 7, scope: !142)
!162 = !DILocation(line: 73, column: 5, scope: !142)
!163 = !DILocation(line: 74, column: 15, scope: !142)
!164 = !DILocation(line: 74, column: 7, scope: !142)
!165 = !DILocation(line: 74, column: 5, scope: !142)
!166 = !DILocation(line: 76, column: 6, scope: !142)
!167 = !DILocation(line: 76, column: 10, scope: !142)
!168 = !DILocation(line: 76, column: 16, scope: !142)
!169 = !DILocation(line: 76, column: 4, scope: !142)
!170 = !DILocation(line: 77, column: 6, scope: !142)
!171 = !DILocation(line: 77, column: 10, scope: !142)
!172 = !DILocation(line: 77, column: 17, scope: !142)
!173 = !DILocation(line: 77, column: 4, scope: !142)
!174 = !DILocation(line: 79, column: 11, scope: !142)
!175 = !DILocation(line: 79, column: 2, scope: !142)
!176 = !DILocation(line: 80, column: 11, scope: !142)
!177 = !DILocation(line: 80, column: 2, scope: !142)
!178 = !DILocation(line: 81, column: 2, scope: !142)
