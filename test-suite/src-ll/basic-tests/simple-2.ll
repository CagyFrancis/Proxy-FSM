; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\basic-tests\simple-2.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\basic-tests\\simple-2.c"
...
define dso_local i32 @main() #0 !dbg !8 {
  ...
  store i32* %5, i32** %2, align 8, !dbg !27
  store i32* %6, i32** %3, align 8, !dbg !28
  store i32* %7, i32** %4, align 8, !dbg !29
  %8 = load i32*, i32** %3, align 8, !dbg !30
  store i32* %8, i32** %2, align 8, !dbg !31
  %9 = load i32*, i32** %4, align 8, !dbg !32
  store i32* %9, i32** %2, align 8, !dbg !33
  ret i32 0, !dbg !34
}
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\basic-tests/simple-2.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/basic-tests/simple-2.c", directory: "")
...
!25 = !DILocalVariable(name: "z", scope: !8, file: !9, line: 10, type: !12)
!26 = !DILocation(line: 10, column: 12, scope: !8)
!27 = !DILocation(line: 12, column: 4, scope: !8)
!28 = !DILocation(line: 13, column: 4, scope: !8)
!29 = !DILocation(line: 14, column: 4, scope: !8)
!30 = !DILocation(line: 15, column: 6, scope: !8)
!31 = !DILocation(line: 15, column: 4, scope: !8)
!32 = !DILocation(line: 16, column: 6, scope: !8)
!33 = !DILocation(line: 16, column: 4, scope: !8)
