; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\path-tests\path-15.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\path-tests\\path-15.c"
...
define dso_local i32 @main() #0 !dbg !8 {
  ...
  store i32* %7, i32** %6, align 8, !dbg !30
  store i32** %6, i32*** %2, align 8, !dbg !31
  store i32* %8, i32** %3, align 8, !dbg !32
  %9 = load i32**, i32*** %2, align 8, !dbg !33
  %10 = icmp ne i32** %9, null, !dbg !33
  br i1 %10, label %11, label %14, !dbg !35

11:                                               ; preds = %0
  %12 = load i32*, i32** %3, align 8, !dbg !36
  %13 = load i32**, i32*** %2, align 8, !dbg !37
  store i32* %12, i32** %13, align 8, !dbg !38
  br label %15, !dbg !39
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\path-tests/path-15.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/path-tests/path-15.c", directory: "")
...
!20 = !DILocalVariable(name: "w", scope: !8, file: !9, line: 3, type: !15)
!21 = !DILocation(line: 3, column: 20, scope: !8)
!22 = !DILocalVariable(name: "v", scope: !8, file: !9, line: 3, type: !16)
!23 = !DILocation(line: 3, column: 24, scope: !8)
!24 = !DILocalVariable(name: "a", scope: !8, file: !9, line: 3, type: !16)
!25 = !DILocation(line: 3, column: 28, scope: !8)
!26 = !DILocalVariable(name: "a1", scope: !8, file: !9, line: 3, type: !12)
!27 = !DILocation(line: 3, column: 31, scope: !8)
!28 = !DILocalVariable(name: "q1", scope: !8, file: !9, line: 3, type: !12)
!29 = !DILocation(line: 3, column: 35, scope: !8)
!30 = !DILocation(line: 4, column: 7, scope: !8)
!31 = !DILocation(line: 5, column: 7, scope: !8)
!32 = !DILocation(line: 6, column: 7, scope: !8)
!33 = !DILocation(line: 8, column: 9, scope: !34)
!34 = distinct !DILexicalBlock(scope: !8, file: !9, line: 8, column: 9)
!35 = !DILocation(line: 8, column: 9, scope: !8)
!36 = !DILocation(line: 9, column: 14, scope: !34)
!37 = !DILocation(line: 9, column: 10, scope: !34)
!38 = !DILocation(line: 9, column: 12, scope: !34)
!39 = !DILocation(line: 9, column: 9, scope: !34)
!40 = !DILocation(line: 11, column: 11, scope: !34)
