; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\path-tests\path-6.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\path-tests\\path-6.c"
...
11:                                               ; preds = %0
  %12 = load i32*, i32** %5, align 8, !dbg !35
  %13 = icmp ne i32* %12, null, !dbg !35
  br i1 %13, label %14, label %15, !dbg !37

14:                                               ; preds = %11
  store i32** %5, i32*** %2, align 8, !dbg !38
  store i32* %7, i32** %3, align 8, !dbg !40
  br label %15, !dbg !41
...
16:                                               ; preds = %15, %10
  ...
  %18 = load i32**, i32*** %2, align 8, !dbg !43
  store i32* %17, i32** %18, align 8, !dbg !44
  ret i32 0, !dbg !45
}
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\path-tests/path-6.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/path-tests/path-6.c", directory: "")
...
!29 = distinct !DILexicalBlock(scope: !8, file: !9, line: 6, column: 9)
!30 = !DILocation(line: 6, column: 9, scope: !8)
!31 = !DILocation(line: 8, column: 11, scope: !32)
!32 = distinct !DILexicalBlock(scope: !29, file: !9, line: 7, column: 5)
!33 = !DILocation(line: 9, column: 11, scope: !32)
!34 = !DILocation(line: 10, column: 5, scope: !32)
!35 = !DILocation(line: 11, column: 14, scope: !36)
!36 = distinct !DILexicalBlock(scope: !29, file: !9, line: 11, column: 14)
!37 = !DILocation(line: 11, column: 14, scope: !29)
!38 = !DILocation(line: 13, column: 11, scope: !39)
!39 = distinct !DILexicalBlock(scope: !36, file: !9, line: 12, column: 5)
!40 = !DILocation(line: 14, column: 11, scope: !39)
!41 = !DILocation(line: 15, column: 5, scope: !39)
!42 = !DILocation(line: 16, column: 10, scope: !8)
!43 = !DILocation(line: 16, column: 6, scope: !8)
!44 = !DILocation(line: 16, column: 8, scope: !8)
!45 = !DILocation(line: 18, column: 5, scope: !8)
