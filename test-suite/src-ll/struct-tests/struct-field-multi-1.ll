; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\struct-tests\struct-field-multi-1.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\struct-tests\\struct-field-multi-1.c"
...
define dso_local i32 @main() #0 !dbg !8 {
  ...
  %9 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %6, i32 0, i32 1, !dbg !32
  %10 = load %struct.MyStruct*, %struct.MyStruct** %9, align 8, !dbg !32
  %11 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %10, i32 0, i32 0, !dbg !33
  store i32* %3, i32** %11, align 8, !dbg !34
  %12 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %5, i32 0, i32 0, !dbg !35
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\struct-tests/struct-field-multi-1.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/struct-tests/struct-field-multi-1.c", directory: "")
...
!35 = !DILocation(line: 21, column: 8, scope: !8)
