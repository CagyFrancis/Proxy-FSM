; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\struct-tests\struct-field-multi-3.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\struct-tests\\struct-field-multi-3.c"
...
define dso_local i32 @main() #0 !dbg !8 {
  ...
  %11 = load %struct.MyStruct*, %struct.MyStruct** %7, align 8, !dbg !38
  %12 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %11, i32 0, i32 1, !dbg !39
  %13 = load %struct.MyStruct*, %struct.MyStruct** %12, align 8, !dbg !39
  %14 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %13, i32 0, i32 0, !dbg !40
  store i32* %2, i32** %14, align 8, !dbg !41
  %15 = load %struct.MyStruct*, %struct.MyStruct** %6, align 8, !dbg !42
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\struct-tests/struct-field-multi-3.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/struct-tests/struct-field-multi-3.c", directory: "")
...
!42 = !DILocation(line: 22, column: 6, scope: !8)
!43 = !DILocation(line: 22, column: 10, scope: !8)
