; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\struct-tests\struct-assignment-direct.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\struct-tests\\struct-assignment-direct.c"
...
define dso_local i32 @main() #0 !dbg !8 {
  ...
  %6 = getelementptr inbounds %struct.ss, %struct.ss* %4, i32 0, i32 0, !dbg !26
  store i32* %2, i32** %6, align 8, !dbg !27
  %7 = bitcast %struct.ss* %5 to i8*, !dbg !28
  %8 = bitcast %struct.ss* %4 to i8*, !dbg !28
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %7, i8* align 8 %8, i64 8, i1 false), !dbg !28
  %9 = getelementptr inbounds %struct.ss, %struct.ss* %5, i32 0, i32 0, !dbg !29
  %10 = load i32*, i32** %9, align 8, !dbg !29
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\struct-tests/struct-assignment-direct.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/struct-tests/struct-assignment-direct.c", directory: "")
...
!26 = !DILocation(line: 18, column: 5, scope: !8)
!27 = !DILocation(line: 18, column: 8, scope: !8)
!28 = !DILocation(line: 19, column: 7, scope: !8)
!29 = !DILocation(line: 20, column: 9, scope: !8)
!30 = !DILocation(line: 20, column: 4, scope: !8)
!31 = !DILocation(line: 22, column: 2, scope: !8)
