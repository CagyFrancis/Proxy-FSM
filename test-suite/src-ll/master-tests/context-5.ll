; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\master-tests\context-5.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\master-tests\\context-5.c"
...
define dso_local i32 @main() #0 !dbg !24 {
  ...
  store i32** %3, i32*** %2, align 8, !dbg !35
  store i32* %4, i32** %3, align 8, !dbg !36
  %6 = load i32**, i32*** %2, align 8, !dbg !37
  call void @foo(i32** noundef %6, i32* noundef %5), !dbg !38
  ret i32 0, !dbg !39
}
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\master-tests/context-5.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/master-tests/context-5.c", directory: "")
...
!26 = !{!14}
!27 = !DILocalVariable(name: "p2", scope: !24, file: !9, line: 8, type: !12)
!28 = !DILocation(line: 8, column: 11, scope: !24)
!29 = !DILocalVariable(name: "p1", scope: !24, file: !9, line: 8, type: !13)
!30 = !DILocation(line: 8, column: 16, scope: !24)
!31 = !DILocalVariable(name: "a", scope: !24, file: !9, line: 9, type: !14)
!32 = !DILocation(line: 9, column: 9, scope: !24)
!33 = !DILocalVariable(name: "b", scope: !24, file: !9, line: 9, type: !14)
!34 = !DILocation(line: 9, column: 12, scope: !24)
!35 = !DILocation(line: 10, column: 8, scope: !24)
!36 = !DILocation(line: 11, column: 8, scope: !24)
!37 = !DILocation(line: 13, column: 9, scope: !24)
!38 = !DILocation(line: 13, column: 5, scope: !24)
!39 = !DILocation(line: 15, column: 5, scope: !24)
