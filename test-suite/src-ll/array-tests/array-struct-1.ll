; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\array-tests\array-struct-1.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\array-tests\\array-struct-1.c"
...
define dso_local i32 @main() #0 !dbg !8 {
  ...
  %10 = getelementptr inbounds [2 x %struct.MyStruct], [2 x %struct.MyStruct]* %2, i64 0, i64 0, !dbg !37
  %11 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %10, i32 0, i32 0, !dbg !38
  %12 = load i32*, i32** %11, align 16, !dbg !38
  store i32* %12, i32** %5, align 8, !dbg !39
  %13 = getelementptr inbounds [2 x %struct.MyStruct], [2 x %struct.MyStruct]* %2, i64 0, i64 1, !dbg !40
  %14 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %13, i32 0, i32 1, !dbg !41
  %15 = load i32*, i32** %14, align 8, !dbg !41
  store i32* %15, i32** %5, align 8, !dbg !42
  ret i32 0, !dbg !43
}
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\array-tests/array-struct-1.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/array-tests/array-struct-1.c", directory: "")
...
!37 = !DILocation(line: 18, column: 6, scope: !8)
!38 = !DILocation(line: 18, column: 11, scope: !8)
!39 = !DILocation(line: 18, column: 4, scope: !8)
!40 = !DILocation(line: 19, column: 6, scope: !8)
!41 = !DILocation(line: 19, column: 11, scope: !8)
!42 = !DILocation(line: 19, column: 4, scope: !8)
!43 = !DILocation(line: 21, column: 2, scope: !8)
