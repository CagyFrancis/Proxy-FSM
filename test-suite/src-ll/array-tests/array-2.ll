; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\array-tests\array-2.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\array-tests\\array-2.c"
...
define dso_local i32 @main() #0 !dbg !8 {
  ...
  %6 = getelementptr inbounds [2 x i32*], [2 x i32*]* %4, i64 0, i64 0, !dbg !24
  store i32* %2, i32** %6, align 8, !dbg !24
  %7 = getelementptr inbounds i32*, i32** %6, i64 1, !dbg !24
  store i32* %3, i32** %7, align 8, !dbg !24
  call void @llvm.dbg.declare(metadata i32** %5, metadata !25, metadata !DIExpression()), !dbg !26
  %8 = load i32, i32* %2, align 4, !dbg !27
  %9 = sext i32 %8 to i64, !dbg !28
  %10 = getelementptr inbounds [2 x i32*], [2 x i32*]* %4, i64 0, i64 %9, !dbg !28
  %11 = load i32*, i32** %10, align 8, !dbg !28
  store i32* %11, i32** %5, align 8, !dbg !29
  %12 = load i32, i32* %3, align 4, !dbg !30
  %13 = sext i32 %12 to i64, !dbg !31
  %14 = getelementptr inbounds [2 x i32*], [2 x i32*]* %4, i64 0, i64 %13, !dbg !31
  %15 = load i32*, i32** %14, align 8, !dbg !31
  store i32* %15, i32** %5, align 8, !dbg !32
  ret i32 0, !dbg !33
}
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\array-tests/array-2.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/array-tests/array-2.c", directory: "")
...
!25 = !DILocalVariable(name: "p", scope: !8, file: !9, line: 7, type: !20)
!26 = !DILocation(line: 7, column: 7, scope: !8)
!27 = !DILocation(line: 9, column: 8, scope: !8)
!28 = !DILocation(line: 9, column: 6, scope: !8)
!29 = !DILocation(line: 9, column: 4, scope: !8)
!30 = !DILocation(line: 10, column: 8, scope: !8)
!31 = !DILocation(line: 10, column: 6, scope: !8)
!32 = !DILocation(line: 10, column: 4, scope: !8)
!33 = !DILocation(line: 12, column: 2, scope: !8)
