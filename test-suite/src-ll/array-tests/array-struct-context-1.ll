; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\array-tests\array-struct-context-1.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\array-tests\\array-struct-context-1.c"
...
define dso_local i32 @main() #0 !dbg !25 {
  ...
  %23 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %22, i64 0, !dbg !65
  %24 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %23, i32 0, i32 0, !dbg !66
  %25 = load i32*, i32** %24, align 8, !dbg !66
  store i32* %25, i32** %9, align 8, !dbg !67
  %26 = load %struct.MyStruct*, %struct.MyStruct** %5, align 8, !dbg !68
  %27 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %26, i64 1, !dbg !68
  %28 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %27, i32 0, i32 1, !dbg !69
  %29 = load i32*, i32** %28, align 8, !dbg !69
  store i32* %29, i32** %9, align 8, !dbg !70
  ret i32 0, !dbg !71
}
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\array-tests/array-struct-context-1.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/array-tests/array-struct-context-1.c", directory: "")
...
!44 = !DILocation(line: 18, column: 12, scope: !25)
...
!66 = !DILocation(line: 29, column: 12, scope: !25)
!67 = !DILocation(line: 29, column: 4, scope: !25)
!68 = !DILocation(line: 30, column: 6, scope: !25)
!69 = !DILocation(line: 30, column: 12, scope: !25)
!70 = !DILocation(line: 30, column: 4, scope: !25)
!71 = !DILocation(line: 32, column: 2, scope: !25)
