; ModuleID = 'd:\Projects\Python\PointerAnalysis\test-suite\src-bc\array-tests\array-struct-context-4.bc'
source_filename = "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\array-tests\\array-struct-context-4.c"
...
define dso_local i32 @main() #0 !dbg !25 {
  ...
  %23 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %22, i32 0, i32 0, !dbg !66
  %24 = load i32*, i32** %23, align 8, !dbg !66
  store i32* %24, i32** %9, align 8, !dbg !67
  %25 = load %struct.MyStruct*, %struct.MyStruct** %5, align 8, !dbg !68
  %26 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %25, i64 1, !dbg !69
  %27 = getelementptr inbounds %struct.MyStruct, %struct.MyStruct* %26, i32 0, i32 1, !dbg !70
  %28 = load i32*, i32** %27, align 8, !dbg !70
  store i32* %28, i32** %9, align 8, !dbg !71
  ret i32 0, !dbg !72
}
...
!1 = !DIFile(filename: "d:\\Projects\\Python\\PointerAnalysis\\test-suite\\src\\array-tests/array-struct-context-4.c", directory: "D:/Projects/Python/PointerAnalysis")
...
!9 = !DIFile(filename: "d:\\Projects/Python/PointerAnalysis/test-suite/src/array-tests/array-struct-context-4.c", directory: "")
...
!66 = !DILocation(line: 29, column: 10, scope: !25)
!67 = !DILocation(line: 29, column: 4, scope: !25)
!68 = !DILocation(line: 30, column: 7, scope: !25)
!69 = !DILocation(line: 30, column: 10, scope: !25)
!70 = !DILocation(line: 30, column: 16, scope: !25)
!71 = !DILocation(line: 30, column: 4, scope: !25)
!72 = !DILocation(line: 32, column: 2, scope: !25)
